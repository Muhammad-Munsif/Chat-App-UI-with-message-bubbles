document.addEventListener('DOMContentLoaded', function() {
    ...
    function sendMessage(e) {
        ...
        setTimeout(() => {
            addMessage("Thanks for your message! I'll get back to you soon.", true, getCurrentTime());
            scrollToBottom();
            ...
            setTimeout(() => {
                ...
                addMessage("By the way, did you see the new updates to the project?", true, getCurrentTime());
                scrollToBottom();
            }, 2000);
        }, 1000);
    }
