<script>
    ...
    const chatMessages = {
      1: [
        { id: 1, type: "text", content: "Hey there! How are you doing today?", incoming: true, time: "10:30 AM", reactions: { "👍": 1 } },
        { id: 2, type: "text", content: "I'm doing great! Just working on this amazing chat UI redesign.", incoming: false, time: "10:32 AM" },
        { id: 3, type: "image", content: "Check out this awesome view from my hike!", url: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", incoming: true, time: "10:35 AM", reactions: { "❤️": 2, "😍": 1 } },
        { id: 4, type: "text", content: "Wow, that's absolutely stunning! Where was this taken?", incoming: false, time: "10:36 AM" },
        { id: 5, type: "video", content: "This video perfectly captures the moment!", url: "https://assets.mixkit.co/videos/preview/mixkit-tree-with-yellow-flowers-1173-large.mp4", incoming: true, time: "10:37 AM" }
      ],
      2: [
        { id: 1, type: "text", content: "Hi Alice! How's your day going?", incoming: false, time: "9:15 AM" },
        { id: 2, type: "text", content: "Going well! Just finished my morning meetings. Can we meet tomorrow for coffee?", incoming: true, time: "9:20 AM", reactions: { "☕": 1 } }
      ],
      4: [
        { id: 1, type: "text", content: "Thanks for your help with the project presentation!", incoming: true, time: "2 hours ago" },
        { id: 2, type: "text", content: "You're welcome! Happy to help anytime. Let me know if you need anything else.", incoming: false, time: "1 hour ago" }
      ],
      6: [
        { id: 1, type: "text", content: "Hey Emma, are you free for a quick call about the design system?", incoming: false, time: "11:45 AM" },
        { id: 2, type: "text", content: "Sure! Give me 10 minutes to wrap up what I'm working on.", incoming: true, time: "11:46 AM" }
      ]
    };
    ...
    function updateChatHeader() {
      ...
      elements.currentUserStatusText.textContent = currentUser.status === 'online' ? 'Active now' : 
                                                  currentUser.status === 'away' ? 'Away' :
                                                  currentUser.status === 'dnd' ? 'Do not disturb' : 'Last seen ' + currentUser.lastSeen;
    ...
    function updateConversationsList() {
      document.querySelectorAll('#conversationsList > div').forEach((item, index) => {
    ...
    function searchConversations() {
      ...
      users.forEach((user, index) => {
        ...
        if (userName.includes(searchTerm) || userMessage.includes(searchTerm) || searchTerm === '') {
    ...
    function toggleSidebar() {
      if (isMobile) {
        ...
        document.body.style.overflow = elements.sidebar.classList.contains('active') ? 'hidden' : 'auto';
      }
    }
