...
(function () {
  ...
  window.attachPhoto = () => { alert('attach photo'); els.attachmentMenu.classList.add('hidden'); };
  window.attachFile = () => { alert('attach file'); els.attachmentMenu.classList.add('hidden'); };
